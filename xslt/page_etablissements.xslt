            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-offset-1 col-lg-8" >
                        <div class="jumbotron">
                            <h2><b>Bienvenue sur l'espace de gestion des Etablissements</b> !</h2><br/><hr/>
                                ...
                                <tbody>
                                        ...
                                        <xsl:for-each select="base/etablissements/etablissement/laboratoire">
                                            <tr class="odd gradeX">
                                                ...
                                                <td>Laboratoire</td>
                                                <td><xsl:value-of select="./adresse/rue"/>&#160;<xsl:value-of select="./adresse/cp"/>&#160;<xsl:value-of select="./adresse/ville"/></td>
                                        ...
                                        <xsl:for-each select="base/etablissements/etablissement/entreprise">
                                            <tr class="odd gradeX">
                                                ...
                                                <td>Entreprise</td>
                                                <td><xsl:value-of select="./adresse/rue"/>&#160;<xsl:value-of select="./adresse/cp"/>&#160;<xsl:value-of select="./adresse/ville"/></td>
                                                <td><xsl:value-of select="./siret"/></td>
                                            </tr>
                                        </xsl:for-each>
