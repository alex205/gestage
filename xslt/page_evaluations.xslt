...
<div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="../index.html"><i class="glyphicon glyphicon-menu-hamburger"></i> Accueil</a>
                </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-offset-1 col-lg-8" >
                        <div class="jumbotron">
                            <h2><b>Bienvenue sur l'espace de gestion des Evaluations</b> !</h2><br/><hr/>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th>Intitule</th>
                                        <th>Note</th>
                                        <th>Comm. technique</th>
                                        <th>Comm. communication</th>
                                        <th>Comm. integration</th>
                                    </tr>
                                ...
                                <tbody>
                                        ...
                                        <xsl:for-each select="base/evaluations/evaluation">
                                            <tr class="odd gradeX">
                                                ...
                                                <td><xsl:value-of select="./commentaire_technique"/></td>
                                                <td><xsl:value-of select="./commentaire_communication"/></td>
                                                <td><xsl:value-of select="./commentaire_integration"/></td>
                                            </tr>
                                        </xsl:for-each>
