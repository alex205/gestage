            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-offset-1 col-lg-8" >
                        <div class="jumbotron">
                            <h2><b>Bienvenue sur l'espace de gestion des Personnes</b> !</h2><br/><hr/>
                                ...
                                <tbody>
                                        ...
                                        <xsl:for-each select="base/personnes/personne/encadrant/industriel">
                                            <tr class="odd gradeX">
                                                ...
                                                <xsl:variable name="idEta" select="../@id_etablissement"/>		
                                                <xsl:for-each select="//base/etablissements/etablissement">
                                                <xsl:variable name="idEtablissement" select="./@id"/>
                                                    <xsl:if test="$idEta=$idEtablissement">
